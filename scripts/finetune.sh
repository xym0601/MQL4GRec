...
load_model_name="/home/xym/data/mql4grec/log/Pet,Cell,Automotive,Tools,Toys,Sports/ckpt_b1024_lr1e-3_seqrec,seqimage/pretrain/checkpoint-32610"

OUTPUT_DIR=/home/xym/models/MQL4GRec/log32610/$Datasets
mkdir -p $OUTPUT_DIR
log_file=$OUTPUT_DIR/train.log

# torchrun --nproc_per_node=2 --master_port=2311 /home/xym/MQL4GRec/finetune.py \
#     --data_path /home/xym/MQL4GRec/data \
#     --dataset $Datasets \
...
torchrun --nproc_per_node=2 --master_port=2311 /home/xym/MQL4GRec/test_ddp_save.py \
...
# python /home/xym/MQL4GRec/ensemble.py \
#     --output_dir $OUTPUT_DIR\
#     --dataset $Datasets\
#     --data_path /home/xym/MQL4GRec/data\
#     --index_file $Index_file\
